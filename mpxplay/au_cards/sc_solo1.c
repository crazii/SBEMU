...
static const struct pci_device_s snd_es1938_ids[] = {
...
static void snd_es1938_rate_set(struct mpxplay_audioout_info_s *aui)
{
	struct es1938 *chip = aui->card_private_data;
	...
	/* set filter register */
	div0 = 256 - 7160000*20/(8*82*aui->freq_card);
