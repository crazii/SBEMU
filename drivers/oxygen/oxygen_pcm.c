...
int oxygen_hw_params(struct snd_pcm_substream *substream,
...
const struct snd_pcm_ops oxygen_spdif_ops = {
...
const struct snd_pcm_ops oxygen_multich_ops = {
...
const struct snd_pcm_ops oxygen_ac97_ops = {
